...
def content
  [].tap do |children|
      children << code({ dangerouslySetInnerHTML: { __html: %q{<div class="highlight"><table style="border-spacing: 0"><tbody><tr><td class="gutter gl" style="text-align: right"><pre class="lineno">1
2</pre></td><td class="code"><pre>* [Link](http://youchan.org/gibier/sample/)
...
def content
  [].tap do |children|
      children << ul(nil,
                    li(nil, a({href:"http://youchan.org/gibier/sample/", target:"_blank"}, "Link")),
                    li(nil, "http://youchan.org/gibier/sample/")
      )
  end
end
end
